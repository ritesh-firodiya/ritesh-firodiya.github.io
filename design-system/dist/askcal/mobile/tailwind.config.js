...
// source: design-system/core.json + palettes/askcal.json
//
...
/* Reserved: colours that carry meaning in AskCal and may not be
   reused for anything else. Rule 01 — the one six of nine sets arrived at
   independently. See design-system/palettes/askcal.json for what each
...
const RESERVED = {
  conf: {
    ...
    med: "var(--conf-med)",
    "med-bg": "var(--conf-med-bg)",
  },
  macro: {
    carbs: "var(--macro-carbs)",
    "carbs-bg": "var(--macro-carbs-bg)",
    fat: "var(--macro-fat)",
    "fat-bg": "var(--macro-fat-bg)",
    protein: "var(--macro-protein)",
    "protein-bg": "var(--macro-protein-bg)",
  },
};

/* Affordances specific to AskCal: a card lift, a pressed edge, a
   floating action button. Shared geometry stays in SCALES. */
const SHADOWS = { fab: "var(--shadow-fab)" };
