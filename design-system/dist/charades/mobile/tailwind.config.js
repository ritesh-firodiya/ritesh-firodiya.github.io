...
// source: design-system/core.json + palettes/charades.json
//
...
/* Reserved: colours that carry meaning in Charades and may not be
   reused for anything else. Rule 01 — the one six of nine sets arrived at
   independently. See design-system/palettes/charades.json for what each
   one means and why it is spoken for. */
const RESERVED = {
  skip: { DEFAULT: "var(--skip)", bg: "var(--skip-bg)", fg: "var(--skip-fg)" },
};

/* Affordances specific to Charades: a card lift, a pressed edge, a
