...
// source: design-system/core.json + palettes/plan-kid.json
//
...
/* Reserved: colours that carry meaning in Plan-Kid and may not be
   reused for anything else. Rule 01 — the one six of nine sets arrived at
   independently. See design-system/palettes/plan-kid.json for what each
   one means and why it is spoken for. */
const RESERVED = {
  stage: {
    parenting: "var(--stage-parenting)",
    postpartum: "var(--stage-postpartum)",
    "pre-decision": "var(--stage-pre-decision)",
    pregnancy: "var(--stage-pregnancy)",
    trying: "var(--stage-trying)",
  },
};

/* Affordances specific to Plan-Kid: a card lift, a pressed edge, a
